...
生成: 2026-08-30 03:50Z / 対象: 2026-08-26 → 2026-08-30 / 観測 5 回 (1 日 1 回、シンガポールの VPS 1 台から、各回 200 件サンプル)。
...
- 定型文の重複率: 平均 28% (min 4% / max 64%)
- 履歴が流れるまでの推定時間: 平均 21 (min 16 / max 31) 分 (10 MiB のリングが埋まる速さ)

## ルームの増減
- 一覧上のルーム総数: 8327 → 42668 (+34341)
- 新規ルーム作成: 平均 237 (min 59 / max 716) /時

## 市場の温度計 (Binance USDT 建て無期限、メジャー 13 銘柄除外)
- 負乖離シェア: 平均 55% (min 51% / max 57%) (30 日平均の最新値 57%、レジームゲート閾値 80%)
- 資金調達率: 過熱 (+0.05%/8h 以上) 銘柄数 平均 6 (min 3 / max 7) / マイナス銘柄数 平均 49 (min 45 / max 54)
- 清算 (24h、USDT 建てのみ、ストリーム標本): ロング清算 平均 $104M (min $21M / max $179M) / ショート清算 平均 $99M (min $27M / max $159M)
...
Generated 2026-08-30 03:50Z / window 2026-08-26 → 2026-08-30 / 5 daily probes from one VPS (Singapore), 200-message samples.
...
- duplicated canned lines: mean 28% (min 4% / max 64%)
- estimated ring retention: mean 21 (min 16 / max 31) min

## Rooms
- listed room count: 8327 → 42668 (+34341)
- new rooms created: mean 237 (min 59 / max 716) per hour

## Market thermometer (Binance USDT-perps, 13 majors excluded)
- negative-premium share: mean 55% (min 51% / max 57%) (latest 30-day average 57%, regime gate at 80%)
- funding: hot (>= +0.05%/8h) symbols mean 6 (min 3 / max 7) / negative symbols mean 49 (min 45 / max 54)
- liquidations (24h, USDT-perps, sampled stream): long-liq mean $104M (min $21M / max $179M) / short-liq mean $99M (min $27M / max $159M)
